# Dataspace and Data Linking Reader
Daniel Antal, CFA
...
- *Human-in-the-Loop Tasks for Data Management, Citizen Sensing, and
...
`data model` pattern of structuring data (3.1.5) in a database (3.1.7)
